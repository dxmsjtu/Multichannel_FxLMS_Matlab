...
%% Generate noise 
fs =  16000; t  =  40;T  = 0:1/fs:t ;len= length(T);
Re = randn(len,1);
...
%% Drawing the figure 
%%
figue;subplot(2,2,1);plot(E(1,:));grid on ;
subplot(2,2,2);plot(E(2,:));grid on ;
subplot(2,2,3);plot(E(3,:));grid on ;
subplot(2,2,4);plot(E(4,:));grid on ;
W1=a.Get_coefficients();figure ;subplot(2,2,1);plot(W1(:,1));grid on ;
subplot(2,2,2);plot(W1(:,2));grid on ;subplot(2,2,3);plot(W1(:,3));grid on ;
subplot(2,2,4);plot(W1(:,4));grid on ;%%
